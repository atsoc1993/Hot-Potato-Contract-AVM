 ...
 */
export type AlgoPotatoCreateCallParams =
  | Expand<AppClientBareCallParams & {method?: never} & {onComplete?: OnApplicationComplete.NoOpOC} & CreateSchema>
/**
 * Defines arguments required for the deploy method.
 */
export type AlgoPotatoDeployParams = Expand<Omit<AppFactoryDeployParams, 'createParams' | 'updateParams' | 'deleteParams'> & {
  /**
   * Create transaction parameters to use if a create needs to be issued as part of deployment; use `method` to define ABI call (if available) or leave out for a bare call (if available)
   */
  createParams?: AlgoPotatoCreateCallParams
}>
...
/**
 * A factory to create and deploy one or more instance of the AlgoPotato smart contract and to create one or more app clients to interact with those (or other) app instances
 */
export class AlgoPotatoFactory {
  /**
  ...
  /**
   * Creates a new instance of `AlgoPotatoFactory`
   *
  ...
  public getAppClientById(params: AppFactoryAppClientParams) {
    return new AlgoPotatoClient(this.appFactory.getAppClientById(params))
  }
  ...
  public async getAppClientByCreatorAndName(
    ...
    return new AlgoPotatoClient(await this.appFactory.getAppClientByCreatorAndName(params))
  }

  /**
   * Idempotently deploys the AlgoPotato smart contract.
   *
   * @param params The arguments for the contract calls and any additional parameters for the call
   * @returns The deployment result
   */
  public async deploy(params: AlgoPotatoDeployParams = {}) {
    const result = await this.appFactory.deploy({
      ...params,
    })
    return { result: result.result, appClient: new AlgoPotatoClient(result.appClient) }
  }
  ...
  readonly params = {
    ...
    create: {
      /**
       * Creates a new instance of the AlgoPotato smart contract using a bare call.
       *
...
export type AlgoPotatoComposer<TReturns extends [...any[]] = []> = {
  ...
  * Cancels a game if and only if there is no active player 2
   ...
   */
  simulate(): Promise<AlgoPotatoComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<AlgoPotatoComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<AlgoPotatoComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
